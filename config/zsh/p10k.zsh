# Generated by Powerlevel10k configuration wizard on 2025-02-08 at 15:56 CET.
...
# slanted separators, sharp heads, sharp tails, 1 line, compact, many icons, concise,
...
() {
  ...
  # restarting zsh. Edit ~/.zsh/config/zsh/p10k.zsh and source it.
